# [github moSalon](https://github.com/molab-itp/moSalon) ?v=1
...
- [src/let-america-be s0](src/let-america-be?v=1&group=s0)
- [src/let-america-be s1](src/let-america-be?v=1&group=s1)
- [src/let-america-be s2](src/let-america-be?v=1&group=s2)

- [src/faceMesh](src/faceMesh?v=1)
- [src/faceMesh long](src/faceMesh?v=1&long=1)
