...
function poseNet_init() {
  ...
  my.poseNet = new eff_pose_net(props);

  my.output = my.poseNet.output;
}
...
function draw() {
  ...
  if (!my.poseNet || !my.poseNet.poses) return;

  if (my.poseNet.poses.length > 0) {
    first_mesh_check();
  }
