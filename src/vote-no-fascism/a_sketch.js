...
function setup() {
  ...
  my.qrcode_url = () => {
    // return `./qrcode/qrcode_heathercoxrichardson.substack.com.png?v=33`;
    return `./qrcode/qrcode.png?v=33`;
  };
  my.showQRCode = () => {
...
// https://molab-itp.github.io/moSalon/src/vote-no-fascism/?v=33
