...
function setup() {
  ...
  my.qrcode_url = () => {
    // return `./qrcode/qrcode_heathercoxrichardson.substack.com.png?v=77`;
    return `./qrcode/qrcode.png?v=77`;
  };
  my.showQRCode = () => {
...
// https://molab-itp.github.io/moSalon/src/vote-no-fascism/?v=77
